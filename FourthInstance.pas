  ...
  Molecule = class
    ...
    begin
      ...
      begin
        ...
        atoms[0] := new Atom(0, -offsetY, rC, clr);
        atoms[1] := new Atom(-offsetX + 15, offsetY, rS, clr);
        atoms[2] := new Atom(+offsetX - 1, offsetY, rS, clr);
      end
      else
      begin
        var rL := r;
        ...
        atoms[0] := new Atom(-dist / 2, 0, rL, clr);
        atoms[1] := new Atom(+dist / 2, 0, rR, clr);
      end;
